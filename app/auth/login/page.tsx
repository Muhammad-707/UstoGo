    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 sm:p-12 w-full max-w-md shadow-2xl space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">Sign in to your UstoGo account</p>
        </div>

        {/* Quick Demo Login Buttons */}
        <div className="space-y-2">
          <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block text-center">Quick Demo Switcher</span>
        ...
        <div className="text-center text-xs text-slate-500 space-y-1">
          ...
          <div className="flex justify-center gap-4 font-bold text-blue-600">
            <Link href="/auth/register/client" className="hover:underline">Register as Client</Link>
            <span>•</span>
            <Link href="/auth/register/master" className="hover:underline text-amber-500">Join as Master</Link>
          </div>
        </div>
