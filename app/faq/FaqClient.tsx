  ...
  return (
    <div className="pb-24">
      ...
      <section className="relative isolate overflow-hidden border-b border-slate-200/70 dark:border-slate-800/70">
        ...
        <div className="page-shell page-shell-narrow relative space-y-6 py-8 sm:py-16 text-center">
      ...
      <div className="page-shell page-shell-narrow space-y-10 py-6 sm:py-12">
        {hits === 0 && (
          <EmptyState
            icon="search"
            title={t('noResults')}
