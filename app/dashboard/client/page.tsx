...
export default function ClientDashboardPage() {
  ...
  return (
    <DashboardLayout role="CLIENT" title={t('title')} subtitle={t('overview')}>
      {/* Hero Banner */}
      <div className="relative bg-gradient-to-br from-blue-600 via-sky-500 to-teal-500 rounded-3xl p-6 sm:p-8 overflow-hidden shadow-xl shadow-blue-500/20">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-xs mt-0.5">{t('overview')}</p>
            </div>
          </div>
