    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mt-1">Client Dashboard</h1>
        </div>
        <Link
          href="/booking"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { title: 'Total Spent', value: '$580.00', icon: 'DollarSign', color: 'from-blue-600 to-sky-500' },
          { title: 'Active Bookings', value: '2 Jobs', icon: 'Clock', color: 'from-amber-500 to-orange-500' },
          { title: 'Completed Projects', value: '14 Jobs', icon: 'CheckCircle2', color: 'from-emerald-500 to-teal-500' },
          { title: 'Saved Masters', value: '5 Masters', icon: 'Heart', color: 'from-purple-500 to-pink-500' },
        ].map((m, idx) => (
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 space-y-6 shadow-xl">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Recent Service Bookings</h3>
          <Link href="/booking/b-101" className="text-xs font-bold text-blue-600 dark:text-sky-400 hover:underline">
            View Active Job Tracker →
          </Link>
        </div>
