...
export default function MasterDashboardPage() {
  ...
  return (
    <DashboardLayout role="MASTER" title={t('title')} subtitle={t('overview')} action={
      ...
      {/* Hero Banner */}
      <div className="relative bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 rounded-3xl p-6 sm:p-8 overflow-hidden shadow-xl shadow-amber-500/20">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-amber-100 text-xs mt-0.5">{t('overview')}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
