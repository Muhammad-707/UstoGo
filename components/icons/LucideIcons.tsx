...
export const Icon: React.FC<IconProps> = ({ name, size = 20, className = '', ...props }) => {
  ...
  switch (name.toLowerCase()) {
    ...
    case 'paintbrush':
      return (
        <svg {...iconProps}>
          <path d="M18.37 2.63a2.12 2.12 0 0 1 3 3L11.37 15.63a2.12 2.12 0 0 1-1.5.63H6.5v-3.37a2.12 2.12 0 0 1 .63-1.5L18.37 2.63z" />
          <path d="M9 14l-4.5 4.5a2.12 2.12 0 0 0 3 3L12 17" />
        </svg>
      );
    case 'hammer':
      return (
        <svg {...iconProps}>
          ...
          <path d="M17.64 3.36a2 2 0 0 1 2.83 2.83l-3 3-2.83-2.83 3-3z" />
          <path d="M14 6l3 3" />
        </svg>
      );
    case 'sparkles':
    ...
    case 'key':
      return (
        <svg {...iconProps}>
          <path d="m21 2-2 2m-1.5 1.5L14 9.5a5 5 0 1 0 2.5 2.5L20 8.5m-3-3.5 3 3" />
        </svg>
      );
    case 'star':
      return (
